<%@ Page Title="" Language="C#" MasterPageFile="~/PaginaMaestra/MPInicio.master" AutoEventWireup="true" CodeFile="PCrearCliente.aspx.cs" Inherits="WebForm_Cliente_PCrearCliente" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="container">
        <h1>Formulario de Ingreso de Nuevo Cliente</h1>
        ...
        <asp:Button ID="btnGuardar" Text="Guardar Nuevo Cliente" runat="server" OnClick="btnGuardar_Click" CssClass="btn btn-primary" />
